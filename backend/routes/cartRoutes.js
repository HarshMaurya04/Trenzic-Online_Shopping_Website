  ...
  try {
    ...
    if (productIndex > -1) {
      ...
      if (quantity > 0) {
        ...
        cart.products.splice(productIndex, 1); // Remove product if quentity is 0
      }
...
// @desc Remove a productfrom the cart
// @access Public
...
// @route GET /api/cart
// @desc Get logged-in user's or quest's cart
// @access Public
  ...
  try {
    ...
    if (guestCart) {
      ...
      if (userCart) {
        ...
        // Remove the quest cart after merging
        try {
